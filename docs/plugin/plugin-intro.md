...
2. 在弹出的脚本制作窗口中，输入脚本内容
3. 点击"保存脚本"按钮，选择保存路径，并输入密码，确定保存
...
1. 在脚本制作窗口中，点击"打开脚本"按钮，选择要查看的脚本文件(.sec格式)
2. 输入正确密码，确认后即可查看该脚本的内容
3. 修改脚本内容后，点击"保存脚本"按钮，选择保存路径，并输入密码，确定保存

## 如何调试脚本
1. 在脚本制作窗口中，选择要调试的代码行，或者调试的起始位置
